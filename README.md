...
本项目**不是**在评估 PRD 写得好不好。

它评估的是：**Agent 能否生成一个有效的 Skill，使 Claude 产出的 PRD 质量得到提升。**
...
This project does **not** evaluate whether a PRD is good. It evaluates whether an **Agent can generate a Skill that makes PRDs better**.
