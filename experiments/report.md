...
## 五、zero_shot vs few_shot 对比（B1，v1 断言版本）
...
| Case | 场景 | zero_shot Gain | few_shot Gain | 变化 |
|---|---|---|---|---|
| b1_tc_01 | 电商购物车 | +0.103 | +0.076 | ↓ -0.027 |
| b1_tc_02 | 社交点赞 | +0.410 | +0.461 | ↑ +0.051 |
| b1_tc_03 | 用户注册登录 | +0.262 | +0.285 | ↑ +0.023 |
| b1_tc_04 | 消息通知 | +0.170 | +0.248 | ↑ +0.078 |
| b1_tc_05 | 搜索功能 | +0.184 | +0.263 | ↑ +0.079 |
| b1_tc_edge_01 | 极简需求描述 | +0.232 | **+0.532** | ↑↑ +0.300 |
| b1_tc_edge_02 | 跨平台复杂需求 | +0.256 | +0.356 | ↑ +0.100 |
| **整体** | | **+0.231** | **+0.326** | **↑ +0.095** |

### 5.3 关键洞察

- few_shot Skill 在整体 Gain 上比 zero_shot 高 +0.095，示例引导有效
- 提升最显著的是极简需求场景（+0.300），说明 few_shot Skill 在输入信息不足时有更强的结构化引导能力
- 电商购物车场景 few_shot Gain 略低（+0.076 vs +0.103），因为 baseline 得分提升压缩了增益空间
- 两个版本的 baseline 得分基本持平（0.526 vs 0.521），说明 Kimi 的基础能力稳定，差异主要来自 Skill 本身

**注**：B2/B3 的 zero_shot vs few_shot 对比待 few_shot 实验完成后补充。
